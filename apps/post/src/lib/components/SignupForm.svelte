...
<div
	class="absolute w-full h-screen bg-white flex flex-col items-center justify-center z-[101] max-w-[560px]"
	transition:fade={{ duration: 150 }}
>
	<div class="text-[32px] font-bold mb-8">Join Momentum</div>
