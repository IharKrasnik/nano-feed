...
<div class="max-w-[600px] mx-auto">
  ...
  <h3 class="mb-8">
    Add web analytics to your page in seconds 
  </h3>
    ...
    <div class="mb-8" in:fade>
      ...
      <div class="mb-8" in:fade={{ duration: 100 }}>
        ...
        <input
          ...
          placeholder="eg. https://paralect.com"
        />
      </div>

    <div class="mt-12">
      <button on:click={addProject} disabled={!project.name || !project.url}>Create {project.name}</button>
    </div>
  </div>
</div>