<script>
	...
	$: if (
		...
		// if (
		// 	$page.params.page &&
		// 	$page.params.page.slug === ($page.params.subPageSlug || $page.data.pageSlug)
		// ) {
		// 	$currentPage = $page.params.page;
		// } else {
		// 	console.log('loading');
		// 	$currentPage = {
		// 		slug: $page.params.subPageSlug || $page.data.pageSlug,
		...
		// 	get(`pages/${$page.params.subPageSlug || $page.data.pageSlug}`, {
		// 		parentPageSlug: $page.params.subPageSlug ? $page.data.pageSlug : ''
		// 	}).then((loadedPage) => {
