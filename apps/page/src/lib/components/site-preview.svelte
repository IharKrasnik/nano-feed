...
<div class="p-8 md:p-0">
  ...
  <div class="_root">
    <div class="_content {page.demoUrl ? 'flex-col sm:flex-row justify-between py-32 mb-16' : 'flex-column items-center h-screen'}">
      ...
      {#if page.demoUrl}
      <div class="w-full md:w-[600px] mt-8 md:mt-0 md:p-8 md:pr-0">
