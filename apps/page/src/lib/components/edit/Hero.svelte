						...
						<div class="_section">
							<div class="flex w-full justify-between">
								...
								<div
									...
									on:click={() => {
										hero.theme.backgroundImages = hero.theme.backgroundImages || [];

										hero.theme.backgroundImages.unshift({
											id: uuidv4(),
							...
							<div class="flex flex-col gap-y-2">
								{#each hero.theme.backgroundImages || [] as backgroundImage}
									<div>
										<div class="_section">
											<div class="flex gap-x-2 w-full justify-between items-center">
												<FileInput
													...
													theme="light"
													onRemoved={() => {
														hero.theme.backgroundImages = hero.theme.backgroundImages.filter(
															(i) => i.id !== backgroundImage.id
														);
													}}
												/>
											</div>
