...
<a class="_item mb-8 inline-block w-full" href="{feedItem.url}" target="_blank">
  ...
  <div class="flex justify-between items-center">
    ...
    {#if feedItem.source === 'linkedin'}
      <div>
        <svg class="w-[25px] h-[25px]" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="800px" height="800px" viewBox="0 0 490.732 490.732" xml:space="preserve">
          <g style="fill: white;">
            <g>
