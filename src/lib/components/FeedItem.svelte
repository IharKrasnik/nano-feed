...
>
  <div class="relative">
    ...
    {#if feedItem.attachments}
      <div class="mt-2">
        {#each feedItem.attachments as attachment}
          ...
          <video src={attachment.url} style="width: 100%; max-height: 300px;" muted loop autoplay bind:this={videoEl}>
          </video>
    ...
    <div class="flex justify-between items-center">
      ...
      {#if !hideLikes}
        <div class="flex">
          <div class="text-sm text-gray-400 mr-2 items-center justify-center flex items-center mr-4">
            {feedItem.viewsCount || 0}

            <svg class="ml-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="rgba(255, 255, 255, .6)" height="15px" width="15px" version="1.1" viewBox="0 0 512 512" enable-background="new 0 0 512 512">
              <g>
          ...
          <div class="flex items-center {feedItem.isLiked ? 'text-[#ff3838]': 'text-white'}">
            ...
            {#if feedItem.isLiked}
            <div 
              on:click|preventDefault|stopPropagation={likeFeedItem}
            >
              <svg
                class="cursor-pointer ml-2 hover:text-[#ff3838] w-[15px] h-[15px] opacity-80"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 507.168 507.168" xml:space="preserve">
                <g>
                  <g>
            ...
            >
              <svg
              class="svg-icon cursor-pointer ml-2 hover:text-[#ff3838] {feedItem.isLiked ? '': 'opacity-70 hover:opacity-100'}"
