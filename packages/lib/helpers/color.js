...
export let darken = (color, percentage = 0.1) => {
	return pSBC(-percentage, color);
};
...
export let getLuminance = (hexColor) => {
...
export const isDarkColor = (hexColor, { luminanceThreshold = 0.179 } = {}) => {
	return getLuminance(hexColor) <= luminanceThreshold;
};
